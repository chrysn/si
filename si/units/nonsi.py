...
r(nonint("1/10")**10*m,[u"Å",u"Å"],["angstrom",u"ångström"],"distance")
map(1852*m,"M","nautical mile","distance", map="never")
map(nonint("1/10")**28*m2,"b","barn","area", map="never")
map(nonint("1852/3600")*m/s,"kt","knot","speed", map="never")
...
r((10**3/(4*_math.pi))*A/m,"Oe",u"œrsted","magnetic field", map="never")
